...
כדי לקבל את התאוצה, נגזור את $\mathbf{v}$ לפי $t$, כאשר נשים לב שהנגזרת של $r\dot{\theta}\mathbf{e}_{\theta}$ תניב שלושה ביטויים, כי כל אחד מהגורמים במכפלה תלויים ב-$t$:
