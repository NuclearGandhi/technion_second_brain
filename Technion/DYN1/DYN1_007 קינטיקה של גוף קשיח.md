...
כבר [[#תנע זוויתי יחסי|ראינו]] ש:
$$\dot{\mathbf{H}}_{c}=\mathbf{M}_{c}$$
כמו ב[[#מאזן תנע זוויתי יחסי של גק"ש מישורי]], נרצה למצוא ביטוי יותר נוח לתנע זוויתי, הפעם במקרה המרחבי.
...
> 	 $$[I_{ij}]=\pu{kg.m^{2}}$$
> 2. במקרה ה[[#מומנט אינרציה של גק"ש מישורי|מישורי]], קיבלנו שמומנט האינרציה שלנו הוא פשוט סקלר. אבל, גם במוצקים עסקנו בחתכים מישוריים, וקיבלנו *טנזור* אינרציה - מטריצה $2\times 2$.
...
$$\boxed {
\mathbf{H}_{B}=\mathbf{I}_{B}\cdot\boldsymbol{\omega}
 }$$
בכתיב אינדקסי:
$$\boxed {
...
![[DYN1_007/תרגול 10 - קינטיקה של גוף קשיח בתנועה מישורית 2024-08-04 14.03.21.excalidraw.svg]]
...
![[DYN1_007/תרגול 10 - קינטיקה של גוף קשיח בתנועה מישורית 2024-08-04 14.54.45.excalidraw.svg]]
...
![[DYN1_007/תרגול 10 - קינטיקה של גוף קשיח בתנועה מישורית 2024-08-04 15.25.51.excalidraw.svg]]
