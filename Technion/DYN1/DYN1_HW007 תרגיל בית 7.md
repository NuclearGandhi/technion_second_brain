...
\mathbf{H}^{O} & =\mathbf{r}_{PO}\times m\mathbf{v}_{PO} \\[1ex]
 ...
 & =\ell \mathbf{e}_{1}'\times(\ell\dot{\theta}\cos \phi\,\mathbf{e}_{2}'+\ell \dot{\phi}\mathbf{e}_{3}') \\[1ex]
 & =-\ell ^{2}\dot{\phi}\mathbf{e}_{2}'+\ell ^{2}\dot{\theta}\cos \phi\,\mathbf{e}_{3}'
\end{aligned}$$
מסעיף קודם, אנו יודעים ש- $\mathbf{H}^{O}\cdot \mathbf{e}_{3}=\text{const}$:
$$(\ell ^{2}\dot{\phi}\mathbf{e}_{2}'+\ell ^{2}\dot{\theta}\cos \phi\, \mathbf{e}_{3}')\cdot \mathbf{e}_{3}=\text{const} $$
כיוון ש- $\mathbf{e}_{3}=\sin\phi\,\mathbf{e}_{1}'+\cos \phi\,\mathbf{e}_{3}'$:
$$\begin{gathered}
(\ell ^{2}\dot{\phi}\mathbf{e}_{2}'+\ell ^{2}\dot{\theta}\cos \phi\,\mathbf{e}_{3}')\cdot(\sin \phi\,\mathbf{e}_{1}'+\cos \phi\,\mathbf{e}_{3}')=\text{const}  \\[1ex]
