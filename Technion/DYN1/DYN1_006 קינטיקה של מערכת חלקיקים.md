...
### סעיף ב'
חשבו את המקף של הכוח הנורמלי מהרצפה במהלך ההתנגשות.


## שאלה 4
שלוש מסות זהות ${m}_{1}={m}_{2}={m}_{3}=m$ מחוברות בחוט קשיח (בלתי נמתח) העובר סביב גלגלות חסרות מסה וחסרות חיכוך, כמתואר. מקדמי החיכוך בין המסות למשטח האופקי הם ${\mu}_{1}$ ו-${\mu}_{2}$, כמתואר (${\mu}_{2}\geq {\mu}_{1}$). ברגע $t=0$ משוחררת המערכת ממצב מנוחה.

![[DYN1_006/Pasted image 20240728110042.png]]
>סכימת המסות

נתון כי מרחק ${m}_{1}$ ממחסום $A$ הוא ${\ell}_{1}$ ומרחק ${m}_{2}$ ממחסום $B$ הוא ${\ell}_{2}$ (${\ell}_{1}<{\ell}_{2}$).

### סעיף א'
מהו ערכו המינימלי של ${\mu}_{1}$ עבורו המערכת תישאר במנוחה?


### סעיף ב'
ענו על סעיפים ב' ו-ג' הבאים כאשר ${\mu}_{1}=0$:

כאשר ${\mu}_{2}\neq 0$ ומסה ${m}_{2}$ נשארת במנוחה, מהו היחס בין המהירויות $\dfrac{\dot{x}_{1}}{\dot{x}_{3}}$ של המסות ${m}_{1}$ ו-${m}_{3}$?


### סעיף ג'
מהו ערכו ${\mu}_{2}$ שבו המסה ${m}_{2}$ תישאר במנוחה?

### סעיף ד'
בסעיפים ד', ה', ו', ו-ז' פתרו בהנחה ש-${\mu}_{2}$ הינו הערך המינימלי כך ש-${m}_{2}$ תישאר במנוחה.

מהו ערך תאוצת המסה ${m}_{3}$?

### סעיף ה'
מהי מהירות המסה ${m}_{3}$ רגע לפני שמסה ${m}_{1}$ מגיעה למחסום $A$?

### סעיף ו'
אם מהירות המסה ${m}_{3}$ היא $v$ ברגע לפני שמסה ${m}_{1}$ מגיעה למחסום $A$, מהי מהירות המסה ${m}_{3}$ רגע לאחר שמסה ${m}_{1}$ נצמדת למחסום $A$?

### סעיף ז'
לאחר היצמדות המסה ${m}_{1}$ למחסום $A$, המסה ${m}_{2}$ נעה ימינה עד שהיא מתנגשת במחסום $B$. מה תהיה עבודת כוח החיכוך שמבוצעת על המסה ${m}_{2}$ עד שהיא מגיעה למחסום $B$?
