...
$$\boxed {
e=-\dfrac{\mathbf{v}(t_{c}^{+})\cdot\hat{\mathbf{n}}}{\mathbf{v}(t_{c}^{-})\cdot\hat{\mathbf{n}}}
 }$$
...
- כאשר $e=0$, מתקיים $\mathbf{v}(t^{+}_{c})\cdot\hat{\mathbf{n}}=0$, כלומר המהירות של הגוף אחרי ההתנגשות אפסית (bean bag).
- כאשר $e=1$, מתקיים $\mathbf{v}_{}(t^{+}_{c})\cdot\hat{\mathbf{n}}=\mathbf{v}(t^{-}_{C})\cdot\hat{\mathbf{n}}$, כלומר המהירות של הגוף אחרי ההתנגשות שווה למהירותו לפני ההתנגשות (super duper bouncy ball).
...
$$\boxed {
e=-\dfrac{\mathbf{v}_{BA}(t_{c}^{+})\cdot \hat{\mathbf{n}}}{\mathbf{v}_{BA}(t^{-}_{c})\cdot\hat{\mathbf{n}}}
 }$$
