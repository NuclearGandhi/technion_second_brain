...
לפי [[DYN1_003 קינמטיקה של גוף קשיח#חישוב קצב סיבוב מקינמטיקה של שלוש נקודות בגוף|חישוב קצב סיבוב]], אנו יכולים למצוא רק את המהירות הזוויתית הניצבת $\boldsymbol{\omega}^{n}$ של $AB$. היא נתונה ע"י:
...
\boldsymbol{\omega}^{n} & =\dfrac{1}{\ell ^{2}}[(-{v}_{0}t+{a}_{1})\mathbf{e}_{1}+{a}_{2}\mathbf{e}_{2}-({b}_{3}+v_{B}t)\mathbf{e}_{3}]\times(-{v}_{0}\mathbf{e}_{1}-v_{B}\mathbf{e}_{3}) \\[1ex]
 & = \dfrac{1}{\ell ^{2}}[-{a}_{2}v_{B}\mathbf{e}_{1}+v_{B}(-{v}_{0}t+{a}_{1}+{v}_{0}{b}_{3}+v_{B}{v}_{0}t)\mathbf{e}_{2}-{v}_{0}{a}_{2}\mathbf{e}_{3}]
\end{aligned}$$
...
אנו במקרה מישורי, ולכן נוכל [[DYN1_003 קינמטיקה של גוף קשיח#מציאת מהירות זוויתית במישור|למצוא]] את המהירות הזוויתית $\boldsymbol{\omega}$ לפי:
...
$$\begin{aligned}
\mathbf{v}_{OM} & =\cancel{ \mathbf{v}_{M} }+\boldsymbol{\omega}^{O}\times \mathbf{r}_{OM} \\[1ex]
