...
MODEL                := closed_loop_step
MODULES              := closed_loop_step_data.c closed_loop_step_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := closed_loop_step.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := closed_loop_step_ref.rsp
...
# additional includes
REQ_INCLUDES += ;E:/work/me-int1/project_1_Yuval_Ido/6221;E:/work/me-int1/project_1_Yuval_Ido/6221/closed_loop_step_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
