...
קטבים ב- ${\omega}_{n}=\pu{3rad.s^{-1}}$ זה [[ICT1_004 ניתוח מודלי וניתוח תגובת תדירות#רמות תגובות יתר ותדירות טבעית|קטבים שנמצאים]] על מעגל ברדיוס $3$. מאחר והמג"ש עובר דרך מעגל ברדיוס זה, ונקודת החיתוך כנראה תהיה די קרובה, מבחינת מרחק מהציר המדומה, לקוטב על הציר הממשי, נסיק שלפי [[ICT1_004 ניתוח מודלי וניתוח תגובת תדירות#דינמיקה דומיננטית|דינמיקה דומיננטית]] קיים הגבר עבורו יתקיימו התנאים הנדרשים.
