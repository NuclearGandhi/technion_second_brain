...
> 	(למעשה, גם האינטגרל המסוים הוא [[../ALG1/ALG1_009 טרנספורמציות לינאריות#טרנספורמציה לינארית|ט"ל]]).
...
>2. אם $f$ [[Technion/CAL1/CAL1_001 פונקציה#פונקציה חסומה|חסומה]] ב-$[a,b]$ פרט למספר סופי של נקודות, אז $f$ אינטגרבילית ב-$[a,b]$.
