...
נשים לב שהטמרפטורה חייב להיות מוצגת בסקאלת קלוין. בנוסף, שטח הגרף לא ייצג את מעבר החום אם מדובר בתהליך בלתי הפיך.
 ...
 >[!example] דוגמה: 
> מים במצב נוזלי רווי ב-$150^{\circ}\pu{C}$, נמצא במערכת צילינדר-בוכנה. המים עוברים תהליך למצב אד רווי, כאשר הבוכנה חופשייה לזוז בצילינדר. אם השינוי של המצב של המצב נוצר כתוצאה מחימום המים כאשר הוא עובר תהליך הפיך פנימית בלחץ וטמפרטורה קובעים, מצאו את אינטרקציית העבודה והחום הסגולית.
> 
> **פתרון:**
...
כאשר $\sigma_{\text{isol}}$ הוא כלל האנטרופיה שנוצרה במערכת וסביבתה.
...
נשים לב שמשוואה זו לא דורשת ששינוי האנטרופיה יהיה חיובי עבור המערכת וחיבוי עבור הסביבה, אלא רק שסכום יהיה חיובי.
...
מצב המסה שנכנסת ויוצאת היא קבועה. אנו מניחים את אותם הנחות שקבענו ב[[THE1_003 אנליזת נפח בקרה#טורבינה|טורבינה בתהליך מתמיד]]. בנוסף, נניח כי האינטראקציית החום בין הטורבינה וסביבתה זניחה. לכן לפי חוק ראשון בתהליך מתמיד:
$$w={h}_{1}-{h}_{2}$$
...
>[!def] הגדרה: 
 ...
 $$\varepsilon_{c}=\dfrac{-w_{s}}{-w_{}}=\dfrac{{h}_{2s}-{h}_{1}}{{h}_{2}-h_{1}}$$
...
%%[[THE1_006 אנטרופיה 2024-03-14 10.39.00.excalidraw.md|🖋 Edit in Excalidraw]]%%
