...
$$\boxed {
\Delta S_{\text{steam}}=m({s}_{2}-{s}_{1})
 }$$
...
{s}_{4}-{s}_{1} & =2.\pu{5946kJ*kg-1*K-1}
\end{aligned}$$
 נסיק:
 $$\boxed {
\Delta S_{\text{air}}=\pu{3.806kJ*K-1}
 }$$
...
קיבלנו כי ${s}_{2}>{s}_{1}$. נסיק כי הטורבינה יכולה להיות אדיאבטית.
>[!TODO] להבין למה
>
