...
T+\dfrac{1}{2}aT^{2}-a{T}_{\text{in}}\cdot T=\dfrac{{C}_{1}}{3{k}_{0}}r^{3}+{C}_{2} \\[1ex]
\dfrac{1}{2}aT^{2}+(1-a{T}_{\text{in}})T-\dfrac{{C}_{1}}{3{k}_{0}}r^{3}-{C}_{2}=0 \tag{2.1}
\end{gather}$$
...
לכן נוכל להשתמש ב[[HTF1_004 הולכה במצב לא מתמיד#שיטת הקיבול המקובץ|משוואה]] $(\text{5.8})$:
...
נוכל לחזור כעת למצוא את $T({t}_{1})$ בעזרת [[HTF1_004 הולכה במצב לא מתמיד#שיטת הקיבול המקובץ|משוואה]] $(\text{5.6})$:
$$\begin{gathered}
...
$$\begin{gathered}
{F}_{12}+{F}_{22}+{F}_{23}=1 \\[1ex]
{F}_{12}=1-{F}_{23}-{F}_{22}
\end{gathered}$$
נציב ערכים ונקבל:
$${F}_{12}=\dfrac{2\sqrt{ 2 }}{\pi}-\dfrac{1}{3}$$
...
$$\begin{aligned}
 ...
 & {R}_{12}'=\dfrac{1}{{A}_{1}'{F}_{12}}=\pu{0.24952m^{-1}} \\[1ex]
...
$$\begin{aligned}
 & {{J}_{1}=\pu{3354.7W.m^{-2}} } \\[1ex]
 & {{J}_{2}=\pu{3063.9W.m^{-2}} } \\[1ex]
 & {{J}_{3}=\pu{1580.2W.m^{-2}} }
\end{aligned}$$
נוכל כעת לחשב את ${q}_{3}$:
$$\begin{gathered}
{q}_{3}'=\dfrac{{J}_{3}-{E}_{b 3}}{R'_{3}} \\[1ex]
\boxed{{q}_{3}'=\pu{5346.3W.m^{-1}} }
\end{gathered}$$
...
ולכן:
$$U\equiv {h}$$
כך שאת [[HTF1_006 זרימה פנימית#מאזן אנרגיה בזרימה פנימית|משוואה]] $(\text{8.45a})$:
$$\begin{gathered}
...
>טמפרטורה ממוצעת, מקסימלית, ומינימלית בחתך הצינור.