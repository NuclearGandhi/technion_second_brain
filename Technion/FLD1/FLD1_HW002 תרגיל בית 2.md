...
נרצה לחשב את $p_{1}$. נבחר שלושה בקווי זרם על תחתית נפח הבקרה, ונשתמש ב[[../DEQ1/DEQ1_003 משוואת ברנולי ומשוואה מטיפוס הומוגני#משוואת ברנולי|משוואת ברנולי]]:
...
עבור גובה $\Delta \ell_{1}$ (כאשר נשים לב שהמהירות זניחה):
$$\begin{gathered}
{p}_{1}+\rho_{w}g{z}_{1}=p_{2}+\rho_{w}g{z}_{2}  \\[1ex]
\end{gathered}$$
עבור גובה $\Delta h$:
$${p}_{2}+\rho_{\ce{ Hg }}g{z}_{2}=p_{3}+\rho_{\ce{ Hg }}g{z}_{3}$$
עבור גובה $\Delta \ell_{2}$:
$${p}_{3}+\rho_{w}g{z}_{3}=p_{a}+\rho_{w}gz_{a}$$
נסכום את כל שלושת המשוואות:
$$\begin{gathered}
{p}_{1}+{p}_{2}+{p}_{3}+g(\rho_{w}{z}_{1}+\rho_{\ce{ Hg }}{z}_{2}+\rho_{w}{z}_{3})={p}_{2}+{p}_{3}+p_{a}+g(\rho_{w}{z}_{2}+\rho_{\ce{ Hg }}{z}_{3}+\rho_{w}z_{a}) \\[2ex]
{p}_{1}=p_{a}+g(-\rho_{w}\Delta \ell_{1}+\rho_{\ce{ Hg }}\Delta h+\rho_{w}\Delta \ell_{2})
\end{gathered}$$

נשים לב ש- $\Delta \ell_{2}-\Delta \ell_{1}=\dfrac{{D}_{1}-{D}_{2}}{2}+\Delta h$. מבחינת המידות הנתונות, יוצא ש- $\dfrac{{D}_{1}-{D}_{2}}{2}$ קטן משמעותית מהגודל $\Delta h$. לכן, נוכל להזניח אותו בחישוב שלנו. נישאר עם:
$$\begin{gathered}
