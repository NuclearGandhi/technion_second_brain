...
### סעיף א'
כדי להניח [[FLD1_006 צמיגות#קירוב הלובריקציה|לובריקציה]], עלינו לדרוש צמיגות דומיננטית - $\mathrm{Re}\gg 1$, וגם גאומטריה תמירה - $\varepsilon=\dfrac{h}{R}\ll 1$. לרוב נזניח גם כוחות גוף, כך ש- $\mathrm{Re}\gg \mathrm{Fr}$.
...
>[!TODO] TODO: להבין למה הניחו שהמומנט שהעילוי יוצר הוא חיובי
...
>[!TODO] TODO: להבין למה להם יצא שונה
...
## שאלה 4
### סעיף א'
עבור [[FLD1_006 צמיגות#גבול הצמיגות|גבול הצמיגות]] נדרוש ש- $\mathrm{Re}\ll 1$. לגבי גרר סטוקס, לא למדנו.
