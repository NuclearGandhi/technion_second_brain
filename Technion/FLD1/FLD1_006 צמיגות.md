...
ניתן להראות מ[[FLD1_003 חוקי שימור אינטגרליים#חוק שימור המסה האינטגרלי|חוק שימור המסה האינטגרלי]] שאם ${u}_{0}$, אז גם $\dfrac{ \partial p }{ \partial x }$ גם קבוע, ולכן:
$$p={c}_{1}x+{c}_{2}$$
...
נתמקד במקרה בו השדה המגנטי יוצר כוח גוף לינארי מהצורה $f=B\alpha(x/L)\mathbf{x}$ בכיוון ציר $\mathbf{x}$ כאשר $B$ הינו עוצמת השדה המגנטי ו-$\alpha$ קבוע יחידות תואמות.
...
שני האיברים המנורמלים (חסרי מימד) הם בסדר גודל $O(1)$, כך שנוכל לבצע "השוואת מקדמים":
$$\begin{aligned}
...
$$v^{*}=\varepsilon u^{*}$$
מבחינת האיברים החסרי מימד:
$$\dfrac{ \partial U }{ \partial X } +\dfrac{ \partial V }{ \partial Y } =0$$

נעבור למ[[FLD1_004 משוואות נאוויה-סטוקס#משוואות נאוויה-סטוקס|משוואות נאוויה-סטוקס]] למקרה הדו-ממדי, בכיוון $\mathbf{x}$:
...
![[FLD1_006/FLD1_006 צמיגות 2024-07-16 15.10.33.excalidraw.svg]]
>בחירת נפח בקרה קבוע.
...
\int _{\text{in}}\mathbf{u}\cdot(-\mathbf{x}) \, \mathrm{d}A +\int _{\text{out}}\mathbf{u}\cdot\mathbf{x} \, \mathrm{d}A= 0\\[1ex]
...
נעבור ל[[FLD1_004 משוואות נאוויה-סטוקס#משוואות נאוויה-סטוקס|משוואות נאוויה-סטוקס]] למקרה הדו-ממדי, בכיוון $\mathbf{x}$:
$$\rho\left( \dfrac{ \partial u }{ \partial t } + u \dfrac{ \partial u }{ \partial x } +v \dfrac{ \partial u }{ \partial y }   \right)=-\dfrac{ \partial p }{ \partial x } +\mu \left( \dfrac{ \partial ^{2}u }{ \partial x^{2} } +\dfrac{ \partial ^{2}u }{ \partial y^{2} }  \right)+\rho g_{x}$$
