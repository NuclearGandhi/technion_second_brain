...
לפי [[PHY2_001 אלקטרוסטטיקה#חוק קולון|חוק קולון]]:
$$\begin{gathered}
...
כדי למצוא את $\mathbf{F}_{e}$, נשתמש בדוגמה מ[[PHY2_001 אלקטרוסטטיקה#צפיפות מטען|צפיפות מטען]], כאשר נשים לב שבמקרה שלנו $Q=2\pi R\lambda$:
