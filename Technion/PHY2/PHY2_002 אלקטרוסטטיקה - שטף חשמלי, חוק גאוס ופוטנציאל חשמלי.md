...
נרצה לתת הגדרה יותר כללית עבור שטף - כלומר עבור משטח כללי. נוכל לחלק את המשטח הכללי לחלקיו האיניפיניטסימליים עם נורמל $\mathrm{d}\mathbf{s}$, ועליהם לבצע את האינטגרציה.
...
>[!example] דוגמה: שטף של מטען נקודתי
...
>[!example] דוגמה: תיל אינסופי טעון בצפיפות מטען אורכית $\lambda$ אחידה.
...
>[!example] דוגמה: קליפה כדורית דקה ברדיוס $R$ עם צפיפות מטען משטחית קבועה $\sigma$
>נרצה לחשב את את השדה במרחב.
>![[PHY2_002 אלקטרוסטטיקה - שטף חשמלי וחוק גאוס 2024-06-10 21.47.30.excalidraw.svg]]
>עבור $r<R$ - בתוך הכדור, נבנה מטעפת גאוסית כדורית.
...
>[!example] דוגמה: כדור מלא ברדיוס $R$ הטעון בצפיפות מטען נפחית קבועה $\rho$.
>נרצה לחשב את את השדה במרחב.
...
>[!example] Example:  מישור אינסופי בעל צפיפות מטען שטחית קבועה $\sigma$
>נרצה לחשב את את השדה במרחב.
...
$$\boxed {
\mathbf{E}_{2}-\mathbf{E}_{1}=4\pi k\sigma\,\mathbf{z}
 }$$
...
>[!example] דוגמה: פוטנציאל של מטען נקודתי $Q$
>![[PHY2_002 אלקטרוסטטיקה - שטף חשמלי, חוק גאוס ופוטנציאל חשמלי 2024-06-14 22.18.50.excalidraw.svg]]
>$$\begin{gathered}
\varphi(\mathbf{r})=-\int_{\infty }^{r} \mathbf{E} \cdot \mathrm{d}\mathbf{\boldsymbol{\ell}} =-\int_{\infty }^{r} \dfrac{kQ}{r^{2}} \hat{\mathbf{r}} \cdot\, \mathrm{d}r \hat{\mathbf{r}}=-\left[ -\dfrac{kQ}{r^{2}} \right]_{\infty }^{r} \\[1ex]
\boxed {
\varphi (\mathbf{r})=\dfrac{kQ}{r}
 }
\end{gathered}$$

>[!example] דוגמה: פוטנציאל שנוצר על ידי אוסף מטענים נקודתיים
![[PHY2_002 אלקטרוסטטיקה - שטף חשמלי, חוק גאוס ופוטנציאל חשמלי 2024-06-15 08.28.47.excalidraw.svg]]
לפי עקרון הסופרפוזיציה:
...
>[!example] דוגמה: פוטנציאל שנוצר עבור התפלגות מטען נפחית $\rho(\mathbf{r})$
...
>[!example] דוגמה: פוטנציאל הנוצר ע"י קליפה כדורית דקה בעלת רדיוס $R$, הטעונה בצפיפות מטען משטחית אחידה $\sigma$
...
[](PHY2_002/PHY2_002%20אלקטרוסטטיקה%20-%20שטף%20חשמלי,%20חוק%20גאוס%20ופוטנציאל%20חשמלי%202024-06-15%2009.05.30.excalidraw.svg)ים) בין שתי נקודות כלליות $A,B$ עבור חוט דק טעון בצפיפות מטען אחידה $\lambda$, כאשר החוט אינסופי?
