...
plot(fitresult, y, x)
legend({'', '$Linear\ Fit$'}, 'Interpreter', 'latex')
...
text(-0.5, 0.0, sprintf('linear fit: y = %.4fx + %.4f', slope, intercept), 'FontSize', 12, 'Color', 'k', 'Interpreter', 'latex')
