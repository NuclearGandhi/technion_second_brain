...
legend({'Measurements with error bars'}, 'Interpreter', 'latex', 'Location', 'southeast')
hold on
...
grid on
legend({'Measurements with error bars', 'Linear Fit'}, 'Interpreter', 'latex', 'Location', 'southeast')
axis([-1 0.1 -0.5 0.1])
