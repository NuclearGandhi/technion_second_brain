...
### טור מספרים
>[!info] הגדרה:
>תהי $\{ a_{n} \}_{n=1}^{\infty}$ [[DEQ1_003 גבולות של סדרות#סדרה|סדרת]] מספרים. נגדיר לכל $1\leq k$ את:
...
### סכום של טור הנדסי
>[!info] משפט:
>תהי $a_{n}$ [[DEQ1_003 גבולות של סדרות#סדרה הנדסית|סדרה הנדסית]] כאשר $|q|\leq 1$. אזי מתקיים:
...
1. אם $q=\lim_{ n \to \infty }\sqrt[n]{ |a_{n}| }<1$. תהי $\tilde q= \frac{1+q}{2}$ ו- $\varepsilon= \frac{1-q}{2}$. מתקיים:
	...
	כיוון ש- $0\leq\tilde q <1$, אז $\sum_{n=1}^{\infty}(\tilde q)^{n}$ מתכנס (ראו דוגמא ראשונה לאחר הגדרת [[#טור מספרים]]), ולכן ממבחן ההשוואה נובע כי $\sum_{n=1}^{\infty}|a_{n}|$ מתכנס ולכן $\sum_{n=1}^{\infty}a_{n}$ מתכנס $\impliedby$ $a_{n}\xrightarrow[n\to \infty]{}0$.
...
3. קבעו:
	...
	נשים לב כי זהו טור אי שלילי. אם נפתח [[DEQ1_006 פולינום טיילור#פולינום טיילור|טיילור]], נשים לב כי אינטואיטיבית:
...
>	וזה מתקיים אם"ם $p>1$ (לפי [[DEQ1_009 אינטגרל מוכלל#אינטגרלים מיוחדים|האינטגרל המיוחד]]).
...
**הוכחה:**
![[DEQ1_010 טורים 2023-01-24 09.07.46.excalidraw.svg|center]]
%%[[DEQ1_010 טורים 2023-01-24 09.07.46.excalidraw.md|🖋 Edit in Excalidraw]], and the [[DEQ1_010 טורים 2023-01-24 09.07.46.excalidraw.dark.svg|dark exported image]]%%
