---
aliases: ערך עצמי, וקטור עצמי, פולינום אופייני, ריבוי אלגברי, ריבוי גיאומטרי, ע"ע, ו"ע, מטריצה לכסינה
---
...
### לכסון
>[!info] הגדרה:
>יהי $T:V\to V$ [[ALG1_009 טרנספורמציות לינאריות#אופרטור לינארי|אופרטור לינארי]]. אומרים ש-$T$ ניתן **ללכסון**, אם קיים [[Technion/ALG1/ALG1_006 בסיס ומימד#בסיס ומימד|בסיס]] $f=\{ f_{1},f_{2},\dots,f_{n} \}$ של $V$, כך שהצגת $T$ לפיו, היא אלכסונית. כלומר לפי בסיס $f$:
$$[T]_{f}=\begin{pmatrix}
k_{1} &  &  &  \\
& k_{2} &  &  \\
&&\ddots& \\
...
>[!info] משפט:
>אופרטור לינארי $T:V\to V$ לכסין אם"ם יש ב-$V$ בסיס שכולו מורכב מוקטורים עצמיים של $T$.
...
>	![[Technion/ALG1/ALG1_010/ALG1_010 וקטורים עצמיים וערכים עצמיים 2023-01-15 14.39.08.excalidraw.svg]]
...
\end{cases}
\end{gather}$$
> 	למערכת ההומוגנית יש פתרון לא טריוויאלי אם"ם [[ALG1_004 מערכות משוואות לינאריות#מערכת משוואות לינארית|מטריצת המקדמים]] [[ALG1_007 מטריצות הפיכות|לא הפיכה]].
...
>		נשים לב שבינתיים ל-$A$ ו-$B$ יש את אותו הפ"א, ע"ע+ר"א, [[ALG1_003 מטריצות#עקבה|עקבה]], [[ALG1_008 הדטרמיננטה#דטרמיננטה|דטרמיננטה]], ודרגה. בכל זאת, זה לא מעיד על דמיון.
>		$$
>		$$
> 		ע"ע|ר"א|ר"ג
> 		-|-|-
