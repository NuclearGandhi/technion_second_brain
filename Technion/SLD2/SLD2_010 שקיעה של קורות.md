...
בפרק קודם ראינו ש-$F$ ייצור זווית $\theta$ שלילית במערכת צירים שלנו, כי $u_{2,1}$ היא הסיבוב של סיב חומרי שהיה ב-$\underline{e_1}$ לכיוון $\underline{e_2}$. הבחנה זו חשובה עבור הפיצול הבא שנעשה:
