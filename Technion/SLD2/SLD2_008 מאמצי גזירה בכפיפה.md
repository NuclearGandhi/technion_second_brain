...
%%[[SLD2_008 מאמצי גזירה בכפיפה 2024-03-13 08.45.05.excalidraw.md|🖋 Edit in Excalidraw]]%%
...
נשים לב כי הנוסחא ל-$Q$ היא בעצם המונה של מיקום [[../SLD1/SLD1_006 מרכז כובד ומרכז מסה#מציאת מרכז כובד עבור גוף יחיד|מרכז הכובד]] של החתך $\tilde{A}$, ביחס לראשית הצירים שמרכזה במרכז הכובד של $A$:
$$\begin{aligned}
