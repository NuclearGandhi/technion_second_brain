...
>[!def] הגדרה: 
 ...
 לכן, המשמעות הפיזיקלית של הערכים מחוץ לאלכסון של $\varepsilon_{ij}$ ($i\neq j$) היא מחצית הקטנת הזווית בין הסיבים המקבילים ל-$\underline{e_{i}}$ ו-$\underline{e_{j}}$ לפני הדיפורמציה.
...
1. נתונים הסיבים $\underline{n}=\frac{1}{5}(3,4,0)$ ו-$\underline{m}=\frac{1}{5}(-4,3,0)$. כמה משתנה הזווית בינהם עקב הדיפורמציה?
	**פתרון:**
