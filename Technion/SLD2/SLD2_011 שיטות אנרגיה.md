...
> $$
>  כאשר ${\kappa}_{2}=\dfrac{A}{({I}_{22})^{2}}\displaystyle\int _{A} \left( \dfrac{{Q}_{2}}{t} \right)^{2} \, \mathrm{d}A$. פרמטרים אלו הם חסרי מימד, והם נותנים מיד לגבי גאומטריית החתך בלבד.
