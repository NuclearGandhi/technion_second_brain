...
# אינווריאנט
מאוד בדומה ל[[../ALG1/ALG1_009 טרנספורמציות לינאריות#שמורות הדמיון|שמורת דמיון]], לטנזור שביצעו עליו טרנספורמציה קיימים **אינווריאנטים** - ערך שלא משתנה גם לאחר הטרנספורמציה.
