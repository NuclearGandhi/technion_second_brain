...
- **הע"ע $\lambda_{1}$ ו-$\lambda_{2}$ ממשיים ובאותו הסימן**:
	...
	>מסלולים במקרה של צומת יציב. כל מסלול הוא תנאי התחלה שונה - כמו בפתרון כללי למד"ר.
