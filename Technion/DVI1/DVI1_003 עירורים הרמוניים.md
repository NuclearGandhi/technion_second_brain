...
**פתרון**:
![[Technion/DVI1/DVI1_003_code/graph_output/q1pd.png|bookhue|600]]
>דיאגרמת בודה (אבל לא ב-$\pu{decade}$) עבור $v$.

הקוד נמצא ב[GitHub](https://github.com/NuclearGandhi/technion_second_brain/blob/master/Technion/DVI1/DVI1_003_code/q1pd.m).
