...
T =\dfrac{1}{2}\sum_{i=1}^{n=3}{m}_{i}{{\dot{x}_{i}}}^{2}+\dfrac{1}{4}\sum_{i=1}^{n=3}{m}_{i}{{\dot{x}_{i}}}^{2} \\[1ex]
 \boxed {
T=\dfrac{3}{4}\sum_{i=1}^{n=3}{m}_{i}{{{x}_{i}}}^{2} 
 }
\end{gathered}$$

מבחינת אנרגיה פוטנציאלית, יש את האנרגיה של הקפיצים:
$$\begin{aligned}
V & =\dfrac{1}{2}{k}_{t}{{\dot{\theta}_{2}}}^{2}+\dfrac{1}{2}{k}_{1}{{{x}_{1}}}^{2}+\dfrac{1}{2}{k}_{2}({x}_{2}-{x}_{1})^{2}+\dfrac{1}{2}{k}_{2}({x}_{3}-{x}_{2})^{2}+\dfrac{1}{2}{k}_{1}{{{x}_{3}}}^{2}
\end{aligned}$$

נציב $\dot{\theta}_{2}=\dfrac{\dot{x}_{2}}{r}$:
$$\boxed{\begin{aligned}
V & =\dfrac{1}{2}{k}_{t}\dfrac{{{\dot{x}_{2}}}^{2}}{r^{2}}+\dfrac{1}{2}{k}_{1}{{{x}_{1}}}^{2}+\dfrac{1}{2}{k}_{2}({x}_{2}-{x}_{1})^{2}+\dfrac{1}{2}{k}_{2}({x}_{3}-{x}_{2})^{2}+\dfrac{1}{2}{k}_{1}{{{x}_{3}}}^{2}
\end{aligned} }$$
### סעיף ב'
...
לכן משוואות התנועה:
$$\mathbf{M}\ddot{\mathbf{x}}+\mathbf{K}\dot{\mathbf{x}}=\mathbf{Q}$$
