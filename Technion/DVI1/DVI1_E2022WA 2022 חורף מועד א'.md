...
נציב ב[[DVI1_001 מושגי יסוד ומכניקת לגראנז'#משוואות אויילר-לגראנז'|משוואות אויילר-לגראנז']] (כאשר נזכור ש- $c=0,\,M=0$ ולכן $Q=0$):
$$\begin{gather}
...
### סעיף ב'
לפי [[DVI1_001 מושגי יסוד ומכניקת לגראנז'#משוואות אויילר-לגראנז'|משוואות אויילר-לגראנז']]:
$$\begin{aligned}
