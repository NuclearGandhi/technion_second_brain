...
$$\begin{align}
{W}_{d} & =-\varepsilon \left[ {\beta}_{0} \pi A^{2}{\omega}_{n}  + {\beta}_{1} \dfrac{\pi}{4} A^{4}{{{\omega}_{n}}}^{}+{\beta}_{1} \dfrac{3}{4} \pi A^{4}{{{\omega}_{n}}}^{4}\right] \\[1ex]
 & =-\varepsilon A^{2}{\omega}_{n}\pi\left[ {\beta}_{0}+\dfrac{1}{4}{\beta}_{1}A^{2}+\dfrac{3}{4}{\beta}_{1}A^{2}{{{\omega}_{n}}}^{3} \right] \tag{1.2}
\end{align}$$
...
$$\begin{gathered}
\dfrac{2\pi}{{\omega}_{n}}\dot{A}A=-\varepsilon A^{2}{\omega}_{n}\pi\left[ {\beta}_{0}+\dfrac{1}{4}{\beta}_{1}A^{2}+\dfrac{3}{4}{\beta}_{1}A^{2}{{{\omega}_{n}}}^{3} \right] \\[1ex]
\boxed {
\dot{A}=-\dfrac{\varepsilon}{2}A{{{\omega}_{n}}}^{2}\left[ {\beta}_{0}+\dfrac{1}{4}{\beta}_{1} A^{2}+\dfrac{3}{4}{\beta}_{1}A^{2}{{{\omega}_{n}}}^{3}\right]
 }
\end{gathered}$$
