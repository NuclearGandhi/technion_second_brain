...
\end{align}$$
>2. יהי $V$ [[ALG1_005 מרחב וקטורי#מרחב וקטורי|מ"ו]] $n$ מימדי, מעל [[ALG1_001 שדה#שדה|שדה]] $F$, ו-$e=\{e_{1},e_{2},\dots,e_{n} \}$ בסיס סדור שלו. אזי $T(v)=[v]_{e}$ היא ט"ל $T:V\to F^{n}$ כי $[v+w]_{e}=[v]_{e}+[w]_{e}$ ו-$[\alpha \cdot v]_{e}=\alpha[v]_{e}$.
