...
$$\begin{aligned}
 & {x}_{2}=\dfrac{1-1/0.0001}{2-1/0.0001}=\dfrac{1-10000}{2-10000}=\dfrac{-9999}{-9998}=^{*}1.00 \\[1ex]
 & {x}_{1}=\dfrac{1-{x}_{2}}{0.0001}=\dfrac{1-1.00}{0.0001}=0
\end{aligned}$$
הפתרון האמיתי:
$$\begin{aligned}
 & x_{1}^{*}=-1.0002 \\
...
$$\begin{aligned}
 & {x}_{2}=\dfrac{1-1/0.501}{2-1/0.501}=\dfrac{1-1.996}{2-1.996}=\dfrac{-0.996}{0.004}=^{*}-249 \\[1ex]
 & {x}_{1}=\dfrac{1-(-249)}{0.501}=\dfrac{250}{0.501}=^{*}499
\end{aligned}$$
הפתרון האמיתי:
$$\begin{aligned}
 & x_{1}^{*}=500 \\
...
עבור $\varepsilon=0.501$:
$$\begin{aligned}
 & {x}_{2}=\dfrac{1-0.501}{1-2\cdot 0.501}=\dfrac{0.499}{1-1.002}=\dfrac{0.499}{-0.002}=^{*}-250 \\[1ex]
 & {x}_{1}=1-2{x}_{2}=1-2(-250)=501
\end{aligned}$$
הפתרון האמיתי:
$$\begin{aligned}
 & x_{1}^{*}=500 \\
...
$$\begin{aligned}
 & \bar{e}_{\text{abs}} =\begin{pmatrix}
\left|500-501\right| \\
\left|-249.5-(-250)\right|
\end{pmatrix}=\begin{pmatrix}
1 \\
0.5
\end{pmatrix} \\[2ex]
 & \boxed {
\| e_{\text{abs}} \|_{\infty }=1
 }
\end{aligned}$$
...
$$\begin{aligned}
 & \| A\|_{1}=\max_{}(|0.5|+|1|,\, |1|+|2|) =\max(1.5,\, 3) =3\\
\end{aligned}$$
נחשב את $A^{-1}$:
$$\begin{aligned}
...
E & =I-\tilde{I} \\
 ...
 & =\dfrac{7\Delta^{5}}{23040}f^{(4)}(a)+\dfrac{7\Delta^{6}}{46080}f^{(5)}(\xi)
\end{aligned}$$
נסכם:
$$\boxed{\begin{aligned}
...
$$\boxed {
\begin{aligned}
E & =\dfrac{7N}{23040}\Delta^{5} f^{(4)}(\xi)+\mathcal{O}(\Delta^{6})
\end{aligned}
 }$$
 כאשר $0<\xi<\Delta N$.
...
{E}_{2} & =y'_{n}-\dfrac{4y_{n+1}-y_{n+2}-3y_{n}}{2h} \\[1ex]
 & =y'_{n}-\dfrac{4(y_{n}+hy'_{n}+\dfrac{h^{2}}{2}y''_{n}+\dfrac{h^{3}}{6}y'''_{n})-(y_{n}+2hy'_{n}+2h^{2}y''_{n}+\dfrac{4h^{3}}{3}y'''_{n})-3y_{n}+\mathcal{O}(h^{4})}{2h} \\[1ex]
 & =y'_{n}-\dfrac{4y_{n}+4hy'_{n}+2h^{2}y''_{n}+\dfrac{2h^{3}}{3}y'''_{n}-y_{n}-2hy'_{n}-2h^{2}y''_{n}-\dfrac{4h^{3}}{3}y'''_{n}-3y_{n}+\mathcal{O}(h^{4})}{2h} \\[1ex]
 & =y'_{n}-\dfrac{2hy'_{n}-\dfrac{2h^{3}}{3}y'''_{n}+\mathcal{O}(h^{4})}{2h} \\[1ex]
 & =y'_{n}-y'_{n}+\dfrac{h^{2}}{3}y'''_{n}+\mathcal{O}(h^{3}) \\[1ex]
 & =\dfrac{h^{2}}{3}y'''_{n}+\mathcal{O}(h^{3})
\end{aligned}$$
...
\begin{aligned}
 ...
 & {E}_{2}=\dfrac{h^{2}}{3}y'''_{n}+\mathcal{O}(h^{3})
\end{aligned}
 }$$
