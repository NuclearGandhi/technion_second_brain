...
>[!def] הגדרה: 
 ...
 המשוואה $x^{7}u_{x}+\sin(x^{2}+y^{2})u_{y}=e^{xy}u+x^{3}$ היא משוואה לינארית, ואילו $u_{x}^{2}+u^{2}_{y}=1$ היא משוואה לא לינארית.


### תנאים נלווים
- ראה גם [[../DEQ1/DEQ1_001 מבוא#פתרון משוואה דיפרנציאלית|תנאי התחלה]].

אילו תנאים עלינו להוסיף למשוואה כדי להבטיח קיום פתרון יחיד?
...
>[!example] דוגמה: 
>**משוואת החום** החד מימדית היא משוואה מהצורה:
>$$u_{t}=ku_{xx}$$
>כאשר $k$ הוא קבוע שמתאר את התפזרות החום בחומר. פתרון של משוואה זו יתאר לנו את התפלגות הטמפרטורה לאורך מוט חד מימדי, כתלות בזמן.
...
![[PDE1/PDE1_001 הקדמה ומשוואות מסדר ראשון 2024-02-15 21.19.20.excalidraw.svg|300]]
%%[[PDE1/PDE1_001 הקדמה ומשוואות מסדר ראשון 2024-02-15 21.19.20.excalidraw|🖋 Edit in Excalidraw]]%%
...
![[PDE1/PDE1_001 הקדמה ומשוואות מסדר ראשון 2024-02-15 21.40.48.excalidraw.svg]]
%%[[PDE1/PDE1_001 הקדמה ומשוואות מסדר ראשון 2024-02-15 21.40.48.excalidraw|🖋 Edit in Excalidraw]]%%
...
המשוואה
$$L[u]=u_{xx}-u_{yy}=0$$
היא משוואה הומוגנית, ואילו המשוואה
$$L[u]=u_{xx} -u_{yy}=x^{2}$$
