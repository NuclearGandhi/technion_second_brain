...
הפיתוח הזה נקרא **פיתוח לפי פונקציות עצמיות**, או **טור פורייה מוכלל**.
...
טור פורייה זה נקרא **טור פורייה קלאסי**.
נשים לב שקיבלנו באגף ימין פונקצייה מחזורים עם מחזור $T=2L$.

### #אלגוריתם: פיתוח לטור סינוסים או קוסינוסים
בהינתן $f$ מחזורית עם $T=2L$ בקטע $[0,L]$, כלומר בחצי המחזור שלו.
נראה איך אנו מפתחים אותו פעם לפי רק קוסינוסים ופעם רק לפי סינוסים.
