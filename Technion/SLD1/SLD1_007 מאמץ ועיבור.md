...
2. נתונה קורה קשיחה לחלוטין $OB$ בעלת אורך $2L$ הנתמכת ע"י סמך חסר חיכוך ב-$O$. בנקודה $A$ הקורה $AC$ (אורך $L$) מחוברת לקורה $OB$ ע"י פרק חסר חיכוך. בנקודה $B$ מחובר מוט $BD$ הנתמך ע"י שני פרקים חסרי חיכוך בנקודה $B$ ו-$D$. בין הנקודה $C$ לרצפה קיים מרווח $\delta$, כאשר $\delta\ll L$.
