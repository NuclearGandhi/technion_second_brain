...
>[!example] דוגמאות:
>1. קבעו את כוח הגזירה והמומנט כיפוף הנוצרים בקורה תחת הכוח המשורטט:
>	![[Technion/SLD1/SLD1_005/Screenshot_20230526_203939_OneDrive.jpg|book|400]]
>	**פתרון:**
>	נמצא את הכוחות תגובה בסמכים:
>	![[Technion/SLD1/SLD1_005/Screenshot_20230526_204211_OneDrive.jpg|book|400]]
>	$${R}_{1}=\pu{1.6kN} \quad \quad R_{2}=\pu{2.4kN}$$
>	נבצע חתך בנקודה בה מופעל הכוח:
>	![[Technion/SLD1/SLD1_005/Screenshot_20230526_204707_OneDrive.jpg|book|400]]
>	(לא נשרטט כאן את כוח הנורמל כי משום מה בספר מתעלמים ממנו, אבל תאכלס הוא לא באמת משפיע כאן על החישובים שלנו).
>	נביט בחתך השמאלי ונסיק:
>	$$\begin{aligned}
\sum \underline{F}\cdot \underline{e_2}&=1.6-V=0 \\
&\implies V=\pu{1.6kN} \\
\sum \underline{M}^{{R}_{1}}\cdot \underline{e_3} &=-xV+M=0 \\
&\implies M\implies \pu{9.6kN}
\end{aligned}$$
>	ערכים אילו של $M,V$ תקפים לאורך כל החלק של הקורה משמאל לעומס בגודל $\pu{4kN}$.
>	עבור החתך השמאלי:
>	$$\begin{aligned}
\sum \underline{F}\cdot \underline{e_2}&=V+2.4 \\
&\implies V=\pu{2.4kN} \\
\sum \underline{M}^{{R}_{2}}\cdot \underline{e_3}&=(10-x)V \\
&=M=\pu{9.6kN}
\end{aligned}$$
>	תוצאות אילו תקפות רק לצד הימני לעומס בגודל $\pu{4kN}$.
>	נוכל להציג את ערכי $V,M$ לאורך הקורה על גרף:
	>![[Technion/SLD1/SLD1_005/Screenshot_20230526_212732_OneDrive.jpg|book|400]]
	>הכיפוף המקסימלי מתרחש במקום בו כוח הגזירה משנה כיוון. ככל שאנו מתקדמים בכיוון החיובי של $x$, ניתן לראות שהמומנט $M$ הוא למעשה סכימה של כלל השטח המצטבר מתחת לגרף כוח הגזירה.
	>>[!notes] הערות:
	>>1. בספר הם לא מגדירים חתך חיובי/שלילי. הם פשוט בוחרים כיוון ל-$V$ ו-$M$ ונשארים עקביים איתו. לכן הכוחות משורטטים כפי שהם באיורים.
...
## הקשר הכללי בין עומס מפורס, כוח גזירה ומומנטים
...
**תרגילים:**
1. נתון:
	![[Technion/SLD1/Screenshot_20230531_092922_Samsung Notes.jpg|book|500]]
	**פתרון:**
	נשרטט את המערכת השקולה:
	![[Technion/SLD1/SLD1_005 מהלכי כוחות ומומנטים בקורות 2023-05-31 09.46.46.excalidraw.svg]]
	%%[[Technion/SLD1/SLD1_005 מהלכי כוחות ומומנטים בקורות 2023-05-31 09.46.46.excalidraw.md|🖋 Edit in Excalidraw]], and the [[Technion/SLD1/SLD1_005 מהלכי כוחות ומומנטים בקורות 2023-05-31 09.46.46.excalidraw.dark.svg|dark exported image]]%%
	...
	נבצע חתכים:
	חתך $0<x<0.5L$ (השלילי):
	![[Technion/SLD1/SLD1_005 מהלכי כוחות ומומנטים בקורות 2023-05-31 09.59.16.excalidraw.svg]]
	%%[[Technion/SLD1/SLD1_005 מהלכי כוחות ומומנטים בקורות 2023-05-31 09.59.16.excalidraw.md|🖋 Edit in Excalidraw]], and the [[Technion/SLD1/SLD1_005 מהלכי כוחות ומומנטים בקורות 2023-05-31 09.59.16.excalidraw.dark.svg|dark exported image]]%%
	$$\begin{aligned}
...
\end{aligned}$$
	...
	![[Technion/SLD1/SLD1_005 מהלכי כוחות ומומנטים בקורות 2023-05-31 10.17.41.excalidraw.svg]]
	%%[[Technion/SLD1/SLD1_005 מהלכי כוחות ומומנטים בקורות 2023-05-31 10.17.41.excalidraw.md|🖋 Edit in Excalidraw]], and the [[Technion/SLD1/SLD1_005 מהלכי כוחות ומומנטים בקורות 2023-05-31 10.17.41.excalidraw.dark.svg|dark exported image]]%%
		העומס המפורס עד החתך:
		$$\frac{{q}_{1}}{{q}_{0}}=\frac{L-x}{0.5L}\implies {q}_{1}=\frac{2(L-x){q}_{0}}{L} $$
	נחשב את הכוח השקול $F_{q}$ שהעומס המפורס עד החתך מפעיל:
	$$F_{q}=\cancel{ \frac{2}{2} }{q}_{0} \frac{(L-x)^{2}}{L}$$
	מיקומו:

>[!TODO] להשלים	

## עומס מפורס תלת מימדי
