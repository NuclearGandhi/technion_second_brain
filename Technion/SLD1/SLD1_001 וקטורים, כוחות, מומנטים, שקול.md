...
![[Technion/SLD1/SLD1_001/SLD1_001 וקטורים, כוחות, מומנטים, תגובות 2023-04-03 20.18.46.excalidraw.svg|center]]
%%[[Technion/SLD1/SLD1_001/SLD1_001 וקטורים, כוחות, מומנטים, תגובות 2023-04-03 20.18.46.excalidraw|🖋 Edit in Excalidraw]], and the [[SLD1_001 וקטורים, כוחות, מומנטים, תגובות 2023-04-03 20.18.46.excalidraw.dark.svg|dark exported image]]%%
...
> 	![[Technion/SLD1/SLD1_001/Pasted image 20230323142305.png|center]]
...
1. פלטה מרובעת נתמכת ע"י צירים לאורך הקו $BC$ ובאמצעות כפל $AE$ כאשר הנקודה $E$ נמצאת במרכז הקטע $FC$. נסמן את וקטור המתיחות של הכפל באמצעות $\\\underline{T}=|T|\underline{e}^{E/A}$. בנוסף, גודל המתיחות בכבל $|T|=\pu{ 300N }$. את הזווית באיור שמוגדרת כ-$25^{\circ}$ נסמן ב-$\theta$.
		![[Technion/SLD1/SLD1_001/SmartSelect_20230322_094147_Samsung Notes.jpg|center|400]]
	...
	**פתרון:**
	...
	\end{gather}$$
1. שאלה:
	![[Technion/SLD1/SLD1_001/SmartSelect_20230322_105636_Samsung Notes.jpg]]	
		**פתרון:**
...
\underline{r}^{A/O}=12\underline{{e}_{1}}+8\underline{{e}_{2}}-12\underline{{e}_{3}}
	...
	$$\begin{aligned}
		...
		\end{aligned}$$
1. נתון:
	![[Technion/SLD1/SLD1_001/SmartSelect_20230322_110321_Samsung Notes.jpg]]
	**פתרון:**
...
![[Technion/SLD1/SLD1_001/Pasted image 20230403204330.png|center]]
...
### מומנט סביב ציר
![[Technion/SLD1/SLD1_001/Screenshot_20230403_085419_OneDrive.jpg|center|400]]
...
>[!notes] הערות:
> 1. כאשר אנו מחשבים מומנט סביב ציר, יש לחשב את המומנט בחס לנקודה כלשהי על הציר ולהטיל את המומנט בכיוון הציר. אם קו הפעולה חותך את הציר, המומנט שנוצר סביב הציר הוא אפס. גם אם קו הפעולה מקביל לציר גם אז המומנט מתאפס.
...
![[Technion/SLD1/SLD1_001/Pasted image 20230328231149.png|center]]
...
![[Technion/SLD1/SLD1_001/Pasted image 20230403210459.png]]

1. נבחר נקודה נוחה לראשית הצירים, $O$ ונזיז את כל הכוחות לנקודה זו. בחלק $(b)$ ניתן לראות את פעולה זו, ובנוסף נשים לב לכל המומנטים הטהורים שהתווספו לפי [[#מערכת כוח-מומנט (טהור|#מערכת כוח-מומנט (טהור|#מערכת כוח-מומנט (טהור|#מערכת כוח-מומנט (טהור|#מערכת כוח-מומנט (טהור|#מערכת כוח-מומנט (טהור|#מערכת כוח-מומנט (טהור|#מערכת כוח-מומנט (טהור|#מערכת כוח-מומנט (טהור]]]]).
