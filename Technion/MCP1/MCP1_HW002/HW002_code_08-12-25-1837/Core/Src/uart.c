...
void apply_command(void) {
    ...
    if (0 == strcmp(sCmd, "ind")) {
        ind = param;
    }  // param is 0 or 1
    if (0 == strcmp(sCmd, "scan")) {
        scan = param;
    }
    if (0 == strcmp(sCmd, "print")) {
        print = param;
    }
    if (0 == strcmp(sCmd, "delay")) {
        d = param;
    }

    if (0 == strcmp(sCmd, "pwm1")) {
        Pwm[0] = param;
    }
    if (0 == strcmp(sCmd, "pwm2")) {
        Pwm[1] = param;
    }
    if (0 == strcmp(sCmd, "pwm3")) {
        Pwm[2] = param;
    }
    if (0 == strcmp(sCmd, "pwm4")) {
        Pwm[3] = param;
    }

    if (0 == strcmp(sCmd, "kp")) {
        kp = (float)param / 10000;
    }
    if (0 == strcmp(sCmd, "ki")) {
        ki = (float)param / 10000;
    }
    if (0 == strcmp(sCmd, "kd")) {
        kd = (float)param / 10000;
    }

    if (0 == strcmp(sCmd, "ref1")) {
        Ref[0] = param;
    }
    if (0 == strcmp(sCmd, "ref2")) {
        Ref[1] = param;
    }
    if (0 == strcmp(sCmd, "ref3")) {
        Ref[2] = param;
    }
    if (0 == strcmp(sCmd, "ref4")) {
        Ref[3] = param;
    }
    ...
    if (0 == strcmp(sCmd, "test")) {
        TestMode = param;
    }
    if (0 == strcmp(sCmd, "stop")) {
        stop = param;
    }
    if (0 == strcmp(sCmd, "mode")) {
        mode = param;
    }
    if (0 == strcmp(sCmd, "record")) {
        mode = param;
