...
דרך יותר שיטתית המפורטת ב-[[FEM1_000 00350022 אלמנטים סופיים לאנליזה הנדסית#ביבליוגרפיה|(Surana & Reddy, n.d.)]] שיותר נוח לממש אותה ב-MATLAB היא לחשב את הע"ע המקסימלי של $[\mathbf{K}]^{-1}{[\mathbf{M}]}$, שנסמנו ${\lambda}_{\max_{}}$, ואז ה-$\Delta t$ הקריטי הוא:
$$\boxed {
