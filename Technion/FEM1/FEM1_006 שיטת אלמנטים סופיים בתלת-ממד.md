...
$$\begin{aligned}
x(\zeta_1,\zeta_2) &= \frac{1}{4}[(1-\zeta_1)(1-\zeta_2) \cdot 0 + (1+\zeta_1)(1-\zeta_2) \cdot 1 + \dots  \\[1ex]
 &  = 1 + \frac{\zeta_1}{2} \\[3ex]
y(\zeta_1,\zeta_2) &= \frac{1}{4}[(1-\zeta_1)(1-\zeta_2) \cdot 0 + (1+\zeta_1)(1-\zeta_2) \cdot (-1) + \dots  \\[1ex]
 & = \frac{\zeta_2-\zeta_1}{2}
\end{aligned}$$

**מטריצת יעקוביאן**:
$$\mathbf{J} = \begin{pmatrix}
\dfrac{\partial x}{\partial \zeta_1} & \dfrac{\partial x}{\partial \zeta_2} \\[1ex]
...
הדטרמיננטה: 
$$\det(\mathbf{J}) = \frac{1}{2} \cdot \frac{1}{2} - 0 \cdot (-\frac{1}{2}) = \frac{1}{4}$$

ההופכית:
$$\mathbf{J}^{-1} = \frac{4}{1} \begin{pmatrix}
1/2 & 0 \\[1ex]
-1/2 & 1/2
\end{pmatrix} = \begin{pmatrix} 2 & 0 \\ 2 & 2 \end{pmatrix}$$
...
מ-$\mathbf{J}^{-1}$:
$$\begin{pmatrix} \dfrac{\partial \zeta_1}{\partial x} \\ \dfrac{\partial \zeta_2}{\partial x} \end{pmatrix} = \begin{pmatrix} 2 \\ 2 \end{pmatrix}, \qquad \begin{pmatrix} \dfrac{\partial \zeta_1}{\partial y} \\ \dfrac{\partial \zeta_2}{\partial y} \end{pmatrix} = \begin{pmatrix} 0 \\ 2 \end{pmatrix}$$

נגזרות פונקציות הצורה:
$$\begin{aligned}
\frac{\partial \hat{\phi}_1}{\partial \zeta_1} &= -\frac{1}{4}(1-\zeta_2),  &  &  \frac{\partial \hat{\phi}_1}{\partial \zeta_2} = -\frac{1}{4}(1-\zeta_1) \\[1ex]
\frac{\partial \hat{\phi}_2}{\partial \zeta_1} &= \frac{1}{4}(1-\zeta_2),  &  &  \frac{\partial \hat{\phi}_2}{\partial \zeta_2} = -\frac{1}{4}(1+\zeta_1) \\[1ex]
\frac{\partial \hat{\phi}_3}{\partial \zeta_1} &= \frac{1}{4}(1+\zeta_2), &  &  \frac{\partial \hat{\phi}_3}{\partial \zeta_2} = \frac{1}{4}(1+\zeta_1) \\[1ex]
\frac{\partial \hat{\phi}_4}{\partial \zeta_1} &= -\frac{1}{4}(1+\zeta_2),  &  &  \frac{\partial \hat{\phi}_4}{\partial \zeta_2} = \frac{1}{4}(1-\zeta_1)
\end{aligned}$$

לכן:
$$\begin{aligned}
\frac{\partial \hat{\phi}_1}{\partial x} &= -\frac{1}{4}(1-\zeta_2) \cdot 2 + (-\frac{1}{4}(1-\zeta_1)) \cdot 2  \\[1ex]
 & = -\frac{1}{2}(1-\zeta_2) - \frac{1}{2}(1-\zeta_1)  \\[1ex]
 & = -\frac{1}{2}(2-\zeta_1-\zeta_2) \\[3ex]
\frac{\partial \hat{\phi}_1}{\partial y} &= -\frac{1}{4}(1-\zeta_2) \cdot 0 + (-\frac{1}{4}(1-\zeta_1)) \cdot 2  \\[1ex]
 & = -\frac{1}{2}(1-\zeta_1)
\end{aligned}$$

באופן דומה עבור שאר הפונקציות:
$$\begin{aligned}
 & \frac{\partial \hat{\phi}_2}{\partial x}   = -\frac{1}{2}(\zeta_1+\zeta_2), &  & \frac{\partial \hat{\phi}_2}{\partial y} = -\frac{1}{2}(1+\zeta_1) \\[3ex]
 & \frac{\partial \hat{\phi}_3}{\partial x} = \frac{1}{2}(2+\zeta_1+\zeta_2), &  & \frac{\partial \hat{\phi}_3}{\partial y} = \frac{1}{2}(1+\zeta_1) \\[3ex]
 & \frac{\partial \hat{\phi}_4}{\partial x} = -\frac{1}{2}(\zeta_1+\zeta_2), &  & \frac{\partial \hat{\phi}_4}{\partial y} = \frac{1}{2}(1-\zeta_1)
\end{aligned}$$
