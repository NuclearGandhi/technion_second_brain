...
$$ \mathbf{J} = \begin{pmatrix} \frac{\partial x}{\partial \zeta_1} & \frac{\partial x}{\partial \zeta_2} \\ \frac{\partial y}{\partial \zeta_1} & \frac{\partial y}{\partial \zeta_2} \end{pmatrix} $$
...
$$ \begin{pmatrix} \frac{\partial \phi_k}{\partial x} \\ \frac{\partial \phi_k}{\partial y} \end{pmatrix} = (\mathbf{J}^T)^{-1} \begin{pmatrix} \frac{\partial \hat{\phi}_k}{\partial \zeta_1} \\ \frac{\partial \hat{\phi}_k}{\partial \zeta_2} \end{pmatrix} $$
כאשר:
$$ (\mathbf{J}^T)^{-1} = (\mathbf{J}^{-1})^T = \frac{1}{\det(\mathbf{J})} \begin{pmatrix} \frac{\partial y}{\partial \zeta_2} & -\frac{\partial y}{\partial \zeta_1} \\ -\frac{\partial x}{\partial \zeta_2} & \frac{\partial x}{\partial \zeta_1} \end{pmatrix} = \frac{1}{2A_e} \begin{pmatrix} y_{31} & -y_{21} \\ -x_{31} & x_{21} \end{pmatrix} $$
...
$$ \begin{aligned}
\begin{pmatrix} \frac{\partial \phi_1}{\partial x} \\ \frac{\partial \phi_1}{\partial y} \end{pmatrix}  & = \frac{1}{2A_e} \begin{pmatrix} y_{31} & -y_{21} \\ -x_{31} & x_{21} \end{pmatrix} \begin{pmatrix} -1 \\ -1 \end{pmatrix} \\[1ex]
