...
$$\boxed{
\{R\}_{\text{boundary}}^{AB} = \frac{q''_s L}{2} \begin{pmatrix} 1 \\ 1 \end{pmatrix} \begin{matrix} \leftarrow A \\ \leftarrow B \end{matrix}
}$$
...
לכן:
$$\boxed{
\{R\}_{\text{boundary}}^{AB} = \frac{L}{6} \begin{pmatrix} 2q''_{s,A} + q''_{s,B} \\ q''_{s,A} + 2q''_{s,B} \end{pmatrix} \begin{matrix} \leftarrow A \\ \leftarrow B \end{matrix}
}$$
